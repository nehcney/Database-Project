...
int main()
{
	...
	MultiMap::Iterator it =	m.findEqual("c");
	it = m.findEqualOrSuccessor("d");
	it = m.findEqualOrPredecessor("d");
	it = m.findEqualOrSuccessor("c");
	it = m.findEqualOrSuccessor("h");
	it = m.findEqualOrPredecessor("0");

	m.insert("c", 2);

	it = m.findEqualOrPredecessor("c");
	it = m.findEqualOrSuccessor("c");
	...
	it = m.findEqualOrPredecessor("");
	p = m.findEqualOrSuccessor("");
}
*/